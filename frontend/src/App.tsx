...
export default function MoodPlayLanding() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-pink-200 selection:text-pink-900 pb-20 text-gray-800">
      ...
      {/* System Requirements & Download Section */}
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white/40 backdrop-blur-md border border-white/60 shadow-lg rounded-3xl p-8 md:p-12 text-gray-800 flex flex-col">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm md:text-base divide-y divide-white/40">
                  ...
                  <tr>
                    ...
                    <td className="py-5 px-4 text-gray-700 font-medium">6 cores / 12 threads</td>
                    <td className="py-5 pl-4 text-gray-700 font-medium">8–16 cores</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="py-5 px-4 text-gray-700 font-medium">8 GB VRAM<br />
                      <span className="text-xs text-gray-500 font-medium">(NVIDIA GPU)</span>
                    </td>
                    <td className="py-5 pl-4 text-gray-700 font-medium">16 GB VRAM<br />
                      <span className="text-xs text-gray-500 font-medium">(NVIDIA GPU)</span>
                    </td>
                  </tr>
                  <tr>
          ...
          <hr className="my-10 border-white/60" />
            ...
            {!isSignedIn ? (
              <div className="flex flex-col gap-4 w-full">
                ...
                <button 
                  ...
                  className={`flex w-full items-center justify-center gap-3 bg-[#E88DAC] text-white py-4 rounded-xl font-bold transition-all transform shadow-md hover:-translate-y-0.5 hover:shadow-lg ${isAuthenticating ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-90'}`}
                >
                  {isAuthenticating ? (
              ...
              <div className="flex flex-col w-full gap-5 text-center animate-in fade-in zoom-in duration-300">
                <div className="w-16 h-16 bg-white/60 backdrop-blur-sm shadow-sm border border-white/60 text-[#E88DAC] rounded-full flex items-center justify-center mx-auto mb-2">
                ...
                <a
                  ...
                  className="mt-2 w-full bg-[#E88DAC] text-white py-4 px-4 rounded-xl font-bold text-lg hover:opacity-90 transition-all transform hover:-translate-y-0.5 shadow-lg block"
                >
                  Download (.exe)
                </a>
              </div>
